...
class VRT(object):
    ...
    def add_geolocationArray(self, geolocationArray=None):
        ...
        Modifes
        --------
        self.dataset : Add geolocationArray to self
        self.geolocationArray : Sets GEOLOCATION ARRAY metadata
    ...
    def convert_GeolocationArray2GPCs(self, stepX=1, stepY=1):
        ...
        Modifies
        ---------
        self.GCPs : add self.GCPs
        self.geolocationArray : remove self.geolocationArray
    ...
    def remove_geolocationArray(self):
        ...
        self.dataset : Sets GEOLOCATION ARRAY metadata to ''
