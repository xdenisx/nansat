...
class Nansat(Domain):
    ...
    | The instance of Nansat class (the object <n>) contains information
      ...
      The object <n> has methods for high-level operations with data. E.g.:
    ...
    def export(self, fileName, bands=None, rmMetadata=[], addGeolocArray=True,
        ...
        Modifies
        ---------
        netCDF file : Create a netCDF file
    ...
    def get_GDALRasterBand(self, bandID=1):
        ...
        Returns
        --------
        GDAL RasterBand : GDAL RasterBand
    ...
    def get_metadata(self, key=None, bandID=None):
        ...
        Returns
        --------
        string  : a string with metadata if key is given and found
        empty string : an empty string if key is given and not found
        dictionary : a dictionary with all metadata if key is not given
    ...
    def reproject(self, dstDomain=None, eResampleAlg=0, blockSize=None,
        ...
        see also : http://www.gdal.org/gdalwarp.html
    ...
    def write_figure(self, fileName=None, bands=1, clim=None, addDate=False,
        ...
        **kwargs : parameters for Figure().
        ...
        Modifies
        ---------
        image file : creates image file, if fileName is specified
